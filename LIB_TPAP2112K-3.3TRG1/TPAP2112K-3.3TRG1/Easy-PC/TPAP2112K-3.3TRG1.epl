...
(library Library_1
	...
	(patternDef "SOT95P280X125-5N" (originalName "SOT95P280X125-5N")
		...
		(layerContents (layerNumRef 28)
			(line (pt -0.8 1.46) (pt 0.8 1.46) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 0.8 1.46) (pt 0.8 -1.46) (width 0.1))
		)
		...
		(layerContents (layerNumRef 28)
			(line (pt -0.8 0.51) (pt 0.15 1.46) (width 0.1))
		)
		(layerContents (layerNumRef 18)
	...
	(symbolDef "TPAP2112K-3_3TRG1" (originalName "TPAP2112K-3_3TRG1")
	...
	(compDef "TPAP2112K-3.3TRG1" (originalName "TPAP2112K-3.3TRG1") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TPAP2112K-3_3TRG1"))
		...
		(attr "Datasheet Link" "https://datasheet.lcsc.com/lcsc/2205241716_TECH-PUBLIC-TPAP2112K-3-3TRG1_C3021085.pdf")
		(attr "Height" "1.25 mm")
	)
