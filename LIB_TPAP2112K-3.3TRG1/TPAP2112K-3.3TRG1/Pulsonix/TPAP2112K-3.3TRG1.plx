...
//17575892/1637154/2.50/5/3/Integrated Circuit
...
(library Library_1
	...
	(patternDef "SOT95P280X125-5N" (originalName "SOT95P280X125-5N")
		...
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -2.1 1.76) (pt 2.1 1.76) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 2.1 1.76) (pt 2.1 -1.76) (width 0.05))
		)
		...
		(layerContents (layerNumRef 28)
			(line (pt -0.8 1.46) (pt 0.8 1.46) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 0.8 1.46) (pt 0.8 -1.46) (width 0.025))
		)
		...
		(layerContents (layerNumRef 28)
			(line (pt -0.8 0.51) (pt 0.15 1.46) (width 0.025))
		)
		(layerContents (layerNumRef 18)
			(line (pt -0.3 1.46) (pt 0.3 1.46) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 0.3 1.46) (pt 0.3 -1.46) (width 0.2))
		)
	...
	(symbolDef "TPAP2112K-3.3TRG1" (originalName "TPAP2112K-3.3TRG1")
	...
	(compDef "TPAP2112K-3.3TRG1" (originalName "TPAP2112K-3.3TRG1") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TPAP2112K-3.3TRG1"))
		...
		(attr "Manufacturer_Name" "TECH PUBLIC")
		(attr "Manufacturer_Part_Number" "TPAP2112K-3.3TRG1")
		(attr "Mouser Part Number" "")
		(attr "Mouser Price/Stock" "")
		(attr "Arrow Part Number" "")
		(attr "Arrow Price/Stock" "")
		(attr "Description" "600mA, 10uA,High PSRR Voltage Regulator")
		(attr "<Hyperlink>" "https://datasheet.lcsc.com/lcsc/2205241716_TECH-PUBLIC-TPAP2112K-3-3TRG1_C3021085.pdf")
		(attr "<Component Height>" "1.25")
		(attr "<STEP Filename>" "TPAP2112K-3.3TRG1.stp")
